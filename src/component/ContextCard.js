           ...
           <div className="card vh-100 w-75 mx-auto">
               <div className="card-header">
                    <div className="d-flex justify-content-between">
                        ...
                        <div className="shopping-icon position-relative">
                            ...
                            <span className="position-absolute item-badge">7</span>
                        </div>
                    </div>
               </div>
               <div className="card-body ps-4 mt-4">
                    <div className="heading">
                        <h3>Shopping Card</h3>
                        <p className="total-item">you have <span className="total-items-count">7</span> Items in shopping card</p>
                    </div>
                    ...
                    <div className="card-total float-end mt-3">
                        <h4>Card Total <span>10000Rs</span></h4>
